(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vert"] = factory(require("vue"));
	else
		root["vert"] = factory(root["Vue"]);
...
exports.InjectionUtils = undefined;
...
var _internalInjectors = __webpack_require__(64);

var _injectable = __webpack_require__(68);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var InjectionUtils = function () {
    function InjectionUtils() {
        (0, _classCallCheck3.default)(this, InjectionUtils);
    }
     ...
     * @return {boolean}
     */
    InjectionUtils.checkInjectable = function checkInjectable(target) {
        // Target must be signed with "$$isInjectable"
        if (!target[_injectable.injectableIndicator]) {
            console.error('[' + _index.appConfig.name + '] Class "' + target.name + '" can\'t be injected because it is non-injectable. ' + 'Please decorate it with "Service" before injection.');
            return false;
        }
        return true;
    };
    ...
    InjectionUtils.createProviderInstance = function createProviderInstance(Provider) {
    ...
    InjectionUtils.createInjectedConstructor = function createInjectedConstructor(targetClass, Providers) {
        // New constructor.
        var Constructor = function Constructor() {
            var providers = [];
            for (var _iterator = Providers, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);;) {
                var _ref;
                ...
                var instance = _internalInjectors.globalInjector.get(Provider) || _internalInjectors.autoInjector.get(Provider);
                if (!instance) {
                    instance = InjectionUtils.createProviderInstance(Provider);
                    _internalInjectors.autoInjector.set(Provider, instance);
                }
    ...
    InjectionUtils.setInjectable = function setInjectable(target) {
        (0, _defineProperty2.default)(target, _injectable.injectableIndicator, {
            configurable: false,
            value: true,
            writable: false
        });
...
exports.InjectionUtils = InjectionUtils;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(105), __webpack_require__(106)))
...
exports.globalInjector = exports.autoInjector = undefined;

var _injector = __webpack_require__(65);

// Global injector holds all instances which are created and injected manually.
var globalInjector = _injector.Injector.create();
// Auto injector holds all instances that are created automatically.
var autoInjector = _injector.Injector.create();
exports.autoInjector = autoInjector;
exports.globalInjector = globalInjector;
...
var _weakMap = __webpack_require__(114);
...
var _injectionUtils = __webpack_require__(24);
...
var Injector = function () {
    function Injector() {
        ...
        Providers.forEach(function (Provider) {
            _this.set(Provider, _injectionUtils.InjectionUtils.createProviderInstance(Provider));
        });
    }
    /**
    ...
    Injector.create = function create() {
        ...
        return new (Function.prototype.bind.apply(Injector, [null].concat(Providers)))();
    };
    /**
    ...
    Injector.prototype.has = function has(Provider) {
    ...
    Injector.prototype.set = function set(Provider, instance) {
...
var _reflectionUtils = __webpack_require__(69);
...
function Injectable(targetClass) {
  _injectionUtils.InjectionUtils.setInjectable(targetClass);
  var Providers = _reflectionUtils.ReflectionUtils.getProvidersFromParams(targetClass);
  return _injectionUtils.InjectionUtils.createInjectedConstructor(targetClass, Providers);
}
...
exports.ReflectionUtils = undefined;

var _getMetadata = __webpack_require__(125);
...
var ReflectionUtils = function () {
    function ReflectionUtils() {
        (0, _classCallCheck3.default)(this, ReflectionUtils);
    }

    ReflectionUtils.getProvidersFromParams = function getProvidersFromParams(target) {
        return ((0, _getMetadata2.default)('design:paramtypes', target) || []).filter(function (item) {
            return typeof item === 'function' && item !== Object && item !== Function;
        });
    };
...
var _appComponent = __webpack_require__(71);
...
var _componentDecorator = __webpack_require__(98);

Object.defineProperty(exports, 'Component', {
  enumerable: true,
  get: function get() {
    return _componentDecorator.Component;
  }
});
Object.defineProperty(exports, 'Prop', {
  enumerable: true,
  get: function get() {
    return _componentDecorator.Prop;
  }
});
Object.defineProperty(exports, 'VueInject', {
  enumerable: true,
  get: function get() {
    return _componentDecorator.VueInject;
  }
});
Object.defineProperty(exports, 'VueProvide', {
  enumerable: true,
  get: function get() {
    return _componentDecorator.VueProvide;
  }
});
Object.defineProperty(exports, 'Watch', {
  enumerable: true,
  get: function get() {
    return _componentDecorator.Watch;
  }
});
...
var _data = __webpack_require__(135);
...
var _inject = __webpack_require__(139);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(12)(Function.call, __webpack_require__(44).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _vuePropertyDecorator = __webpack_require__(103);
...
function Component(options) {
    if (typeof options === 'function') {
        var Providers = _reflectionUtils.ReflectionUtils.getProvidersFromParams(options);
        var Constructor = _injectionUtils.InjectionUtils.createInjectedConstructor(options, Providers);
        return (0, _component.componentFactory)(Constructor, {});
    }
    return function (targetClass) {
        ...
        var Providers = options.providers || _reflectionUtils.ReflectionUtils.getProvidersFromParams(targetClass);
        var Constructor = _injectionUtils.InjectionUtils.createInjectedConstructor(targetClass, Providers);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data__ = __webpack_require__(102);
...
function collectDataFromConstructor(vm, Component) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        if (!(Component.prototype instanceof __WEBPACK_IMPORTED_MODULE_0_vue___default.a) && Object.keys(plainData).length > 0) {
...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(14), __webpack_require__(104), __webpack_require__(61)) :
...
module.exports = __webpack_require__(0).Reflect.getMetadata;
...
var metadata = __webpack_require__(128);
var anObject = __webpack_require__(4);
var getPrototypeOf = __webpack_require__(38);
...
var $export = __webpack_require__(2);
var shared = __webpack_require__(20)('metadata');
var store = shared.store || (shared.store = new (__webpack_require__(66))());
...
var _typeUtils = __webpack_require__(134);
...
var App = exports.App = function () {
    ...
    App.addSingleton = function addSingleton(Provider, instance) {
        _internalInjectors.globalInjector.set(Provider, instance);
    };
    ...
    App.prototype.initViewModel = function initViewModel(RootComponent, _created, _mounted, _beforeDestroy) {
        var option = {
            ...
            created: function created() {
                _typeUtils.TypeUtils.isFunction(_created) && _created(this);
            },
            mounted: function mounted() {
                _typeUtils.TypeUtils.isFunction(_mounted) && _mounted(this);
            },
            beforeDestroy: function beforeDestroy() {
                _typeUtils.TypeUtils.isFunction(_beforeDestroy) && _beforeDestroy(this);
            }
        };
        if (_typeUtils.TypeUtils.isDefined(this._router)) {
            (0, _assign2.default)(option, { router: this._router });
        }
        if (_typeUtils.TypeUtils.isDefined(this._store)) {
            (0, _assign2.default)(option, { store: this._store });
        }
        this._viewModel = new _vue2.default(option);
    };
    /**
     * Start up this app.
     *
...
var TypeUtils = function () {
    function TypeUtils() {
        (0, _classCallCheck3.default)(this, TypeUtils);
    }

    TypeUtils.isUndefined = function isUndefined(target) {
        return typeof target === 'undefined';
    };

    TypeUtils.isDefined = function isDefined(target) {
        return !TypeUtils.isUndefined(target);
    };

    TypeUtils.isFunction = function isFunction(target) {
...
var Data = function () {
    ...
    Data.createTypeSafetyInstance = function createTypeSafetyInstance(Constructor) {
        for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
            args[_key - 1] = arguments[_key];
        }

        var obj = new (Function.prototype.bind.apply(Constructor, [null].concat(args)))();
        if (!isSupportProxy) {
            return obj;
        }
        return new Proxy(obj, {
            set: function set(target, keyName, value, proxy) {
                var newType = getType(value);
                var correctType = getType(target[keyName]);
                if (newType === correctType) {
                    (0, _set2.default)(target, keyName, value);
                } else {
                    console.warn('[Warn] Incorrect data type was given to property "' + keyName + '" on "' + Constructor.name + '":\n' + ('       "' + value + '" (' + getTypeText(newType) + ') was given, but should be a ' + getTypeText(correctType) + '.'));
                }
...
module.exports = __webpack_require__(0).Reflect.set;
