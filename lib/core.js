...
exports.Vuex = exports.Vue = exports.Store = exports.Router = exports.App = undefined;
...
var _core2 = __webpack_require__(142);

var _core3 = __webpack_require__(144);

var _core4 = __webpack_require__(84);
 ...
 * @licence MIT
 */
_core4.Vue.use(_core3.Vuex);
exports.Router = _core2.Router;
exports.Store = _core3.Store;
exports.Vue = _core4.Vue;
exports.Vuex = _core3.Vuex;
...
var App = exports.App = function () {
    ...
    App.use = function use(plugin, options) {
        _core.Vue.use(plugin, options);
    };

    App.prototype.initViewModel = function initViewModel(RootComponent, _created, _mounted, _beforeDestroy) {
        var option = {
            name: this.name,
            ...
            created: function created() {
                _utils.Utils.isFunction(_created) && _created(this);
            },
            mounted: function mounted() {
                _utils.Utils.isFunction(_mounted) && _mounted(this);
            },
            beforeDestroy: function beforeDestroy() {
                _utils.Utils.isFunction(_beforeDestroy) && _beforeDestroy(this);
            }
        };
        if (_utils.Utils.isDefined(this._router)) {
            (0, _assign2.default)(option, { router: this._router });
        }
        if (_utils.Utils.isDefined(this._store)) {
            (0, _assign2.default)(option, { store: this._store });
        }
        this._viewModel = new _core.Vue(option);
    };
    /**
     * Start up this app.
     *
...
var Utils = function () {
    ...
    Utils.isUndefined = function isUndefined(target) {
        return typeof target === 'undefined';
    };

    Utils.isDefined = function isDefined(target) {
        return !Utils.isUndefined(target);
    };

    Utils.isFunction = function isFunction(target) {
...
exports.Vuex = exports.Store = undefined;
