...
var _getOwnPropertyDescriptor = __webpack_require__(87);

var _getOwnPropertyDescriptor2 = _interopRequireDefault(_getOwnPropertyDescriptor);

var _decorator = __webpack_require__(66);
...
var LocalStorage = function () {
    ...
    LocalStorage.prototype.getItem = function getItem(keyName) {
    ...
    LocalStorage.prototype.setItem = function setItem(keyName, data) {
        keyName = this.prefix + keyName;
...
exports.LocalStorage = LocalStorage = __decorate([_decorator.Injectable], LocalStorage);
...
var _srv = __webpack_require__(152);
...
var _srv2 = __webpack_require__(116);

Object.defineProperty(exports, 'LocalStorage', {
  enumerable: true,
  get: function get() {
    return _srv2.LocalStorage;
  }
});

var _srv3 = __webpack_require__(174);
...
var _srv4 = __webpack_require__(187);
...
var GLOBAL_REQUEST_INTERCEPTORS = [];
var GLOBAL_RESPONSE_INTERCEPTORS = [];
/**
 * Http Service.
 *
 * @class Http
...
var Http = function () {
    ...
    Http.prototype.init = function init() {
        var $http = _axios2.default.create({
            timeout: DEFAULT_TIMEOUT
        });
        GLOBAL_REQUEST_INTERCEPTORS.forEach(function (item) {
            $http.interceptors.request.use(item.onFulfilled, item.onRejected);
        });
        GLOBAL_RESPONSE_INTERCEPTORS.forEach(function (item) {
    ...
    Http.addGlobalRequestInterceptor = function addGlobalRequestInterceptor(interceptor) {
    ...
    Http.addGlobalResponseInterceptor = function addGlobalResponseInterceptor(inteceptor) {
    ...
    Http.prototype.get = function get(url, config) {
    ...
    Http.prototype.post = function post(url, data, config) {
    ...
    Http.prototype.addRequestInterceptor = function addRequestInterceptor(onFulfilled, onRejected) {
    ...
    Http.prototype.addResponseInterceptor = function addResponseInterceptor(onFulfilled, onRejected) {
...
exports.Http = Http = __decorate([_decorator.Injectable], Http);
exports.Http = Http;
...
exports.LogLevel = exports.Logger = undefined;

var _classCallCheck2 = __webpack_require__(23);

var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);

var _metadata = __webpack_require__(175);
...
var _srv = __webpack_require__(116);
...
var Logger = function () {
    ...
    Logger.prototype.addLog = function addLog(log) {
    ...
    Logger.prototype.debug = function debug() {
        if (process.env.NODE_ENV === 'development') {
            ...
            var log = createLog.apply(undefined, [LogLevel.debug].concat(content));
            (_console = console).debug.apply(_console, ["[" + LogLevel.debug + "]"].concat(content));
            this.addLog(log);
            return log;
        }
    };
    ...
    Logger.prototype.log = function log() {
        ...
        var log = createLog.apply(undefined, [LogLevel.info].concat(content));
        (_console2 = console).log.apply(_console2, ["[" + LogLevel.info + "]"].concat(content));
        this.addLog(log);
        return log;
    };
    ...
    Logger.prototype.warn = function warn() {
        ...
        var log = createLog.apply(undefined, [LogLevel.warn].concat(content));
        (_console3 = console).warn.apply(_console3, ["[" + LogLevel.warn + "]"].concat(content));
        this.addLog(log);
        return log;
    };
    ...
    Logger.prototype.error = function error() {
        ...
        var log = createLog.apply(undefined, [LogLevel.error].concat(content));
        (_console4 = console).error.apply(_console4, ["[" + LogLevel.error + "]"].concat(content));
        this.addLog(log);
        return log;
    };

    Logger.prototype.getLogs = function getLogs() {
        return this.logPool;
    };

    return Logger;
}();
exports.Logger = Logger = __decorate([_decorator.Injectable, (0, _decorator.Inject)(_srv.LocalStorage), __metadata("design:paramtypes", [_srv.LocalStorage])], Logger);
var LogLevel;
(function (LogLevel) {
...
function createLog(level) {
    for (var _len5 = arguments.length, content = Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
        content[_key5 - 1] = arguments[_key5];
    }
...
var Timer = function () {
    ...
    Timer.prototype.setInterval = function (_setInterval) {
    ...
    Timer.prototype.nextTick = function nextTick(callback) {
    ...
    Timer.prototype.nextJob = function nextJob(callback) {
...
exports.Timer = Timer = __decorate([_decorator.Injectable], Timer);
exports.Timer = Timer;

function doNextTick() {
    if (!tickPromise) {
        tickPromise = new _promise2.default(function (resolve) {
            return resolve();
        }).then(function () {
            nextTicks.forEach(function (func) {
...
function doNextJob() {
    if (!jobTimer) {
        jobTimer = setTimeout(function () {
            nextJobs.forEach(function (func) {
                typeof func === 'function' && func();
            });
            nextJobs = [];
            jobTimer = null;
